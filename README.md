...
```sh
# Using npm
npm install --global tilda-init

# Using yarn
yarn global add tilda-init
```
...
Here is an example how to use this package as library. To install it locally, as library, you can use `npm install tilda-init` (or `yarn add tilda-init`):
